...
(define csegen-7 (vector (lambda (arg-5919) (lambda (arg-5922) (bs+ arg-5919 arg-5922 63))) (lambda (arg-5929) (lambda (arg-5932) (bs* arg-5929 arg-5932 63))) (lambda (arg-5939) (blodwen-toSignedInt arg-5939 63))))
(define csegen-26 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
...
(define csegen-33 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (case (vector-ref arg-8912 0) ((0) (let ((e-2 (vector-ref arg-8912 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-8912 1))) (vector 1 (u--func e-5))))))))))
(define csegen-37 (vector csegen-33 (lambda (u--a) (lambda (arg-9951) (vector 1 arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (case (vector-ref arg-9957 0) ((0) (let ((e-2 (vector-ref arg-9957 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-9957 1))) (case (vector-ref arg-9964 0) ((1) (let ((e-8 (vector-ref arg-9964 1))) (vector 1 (e-5 e-8)))) (else (let ((e-11 (vector-ref arg-9964 1))) (vector 0 e-11)))))))))))))
...
(define csegen-42 (vector csegen-37 (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (PreludeC-45Types-u--C-62C-62C-61_Monad_C-40EitherC-32C-36eC-41 arg-10436 arg-10439))))) (lambda (u--a) (lambda (arg-10450) (PreludeC-45Types-u--join_Monad_C-40EitherC-32C-36eC-41 arg-10450)))))
...
(define PreludeC-45Types-u--toList_Foldable_C-40EitherC-32C-36eC-41 (lambda (ext-0) (PreludeC-45Types-u--foldr_Foldable_C-40EitherC-32C-36eC-41 csegen-26 '() ext-0)))
...
(define csegen-88 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-722 arg-725)))))
...
(define csegen-96 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
(define csegen-105(delay (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8912 eta-0)))))) (lambda (u--a) (lambda (arg-9951) (lambda (eta-0) arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (lambda (world-4) (let ((act-5 (arg-9957 world-4))) (let ((act-3 (arg-9964 world-4))) (act-5 act-3)))))))))))
(define csegen-111(delay (vector (force csegen-105) (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (lambda (world-0) (let ((act-1 (arg-10436 world-0))) ((arg-10439 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10450) (lambda (world-0) (let ((act-1 (arg-10450 world-0))) (act-1 world-0))))))))
(define csegen-112(delay (cons (force csegen-111) (lambda (u--a) (lambda (arg-13044) arg-13044)))))
(define PreludeC-45Types-prim__integerToNat (lambda (arg-0) (let ((sc0 (or (and (<= 0 arg-0) 1) 0))) (cond ((equal? sc0 0) 0)(else arg-0)))))
(define csegen-123 (vector (lambda (arg-5919) (lambda (arg-5922) (+ arg-5919 arg-5922))) (lambda (arg-5929) (lambda (arg-5932) (* arg-5929 arg-5932))) (lambda (arg-5939) (PreludeC-45Types-prim__integerToNat arg-5939))))
...
(define csegen-144(delay (SystemC-45Concurrency-makeChannel (force csegen-112))))
...
(define SystemC-45Info-isWindows ((PreludeC-45Types-elem (force csegen-85) csegen-88 SystemC-45Info-os) (cons "windows" (cons "mingw32" (cons "cygwin32" '())))))
...
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-96 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 (lambda (arg-1 arg-2 ext-0 ext-1) (PreludeC-45InterfacesC-45Monad-u--C-62C-62C-61_Monad_ComposeC-40C-40C-46C-32C-36mC-41C-32C-36tC-41 (force csegen-111) csegen-42 csegen-63 ext-0 ext-1)))
(define SystemC-45Directory-collectDir (lambda (arg-1 arg-2) (let ((e-2 (cdr arg-1))) ((e-2 'erased) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-nextDirEntry (force csegen-112) arg-2) (lambda (_-0) (if (null? _-0) (lambda (eta-0) (vector 1 '())) (let ((e-3 (unbox _-0))) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-collectDir (force csegen-112) arg-2) (lambda (u--ns) (lambda (eta-0) (vector 1 (cons e-3 u--ns)))))))))))))
...
(define TestC-45Golden-n--8205-4603-u--isTest (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (SystemC-45FileC-45Meta-exists (force csegen-112) (string-append arg-4 "/run"))))
...
(define TestC-45Golden-pathLookup (lambda (arg-0 ext-0) (let ((act-1 ((System-getEnv (force csegen-112) "PATH") ext-0))) (let ((u--extensions (let ((sc0 SystemC-45Info-isWindows)) (cond ((equal? sc0 1) (cons ".exe" (cons ".cmd" (cons ".bat" (cons "" '()))))) (else (cons "" '())))))) (let ((u--pathList (DataC-45String-split (lambda (arg-1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-1 SystemC-45Path-pathSeparator)) (DataC-45Maybe-fromMaybe (lambda () "/usr/bin:/usr/local/bin") act-1)))) (let ((u--candidates (PreludeC-45Types-listBind u--pathList (lambda (u--p) (PreludeC-45Types-listBind arg-0 (lambda (u--x) (PreludeC-45Types-listBind u--extensions (lambda (u--y) (PreludeC-45Types-u--pure_Applicative_List (string-append u--p (string-append "/" (string-append u--x u--y)))))))))))) ((SystemC-45FileC-45Meta-firstExists (force csegen-112) u--candidates) ext-0)))))))
(define TestC-45Golden-case--caseC-32blockC-32inC-32checkRequirement-4211 (lambda (arg-0 arg-1 ext-0) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((act-1 ((System-getEnv (force csegen-112) e-2) ext-0))) (if (null? act-1) (TestC-45Golden-pathLookup e-3 ext-0) (let ((e-1 (unbox act-1))) (box e-1))))))))
...
(define TestC-45Golden-testReceiver (lambda (arg-0 arg-1 arg-2 arg-3) (cond ((equal? arg-3 0) (SystemC-45Concurrency-channelPut (force csegen-112) arg-2 arg-1))(else (let ((e-0 (- arg-3 1))) (lambda (world-0) (let ((act-1 ((SystemC-45Concurrency-channelGet (force csegen-112) arg-0) world-0))) (let ((u--nThreads (+ e-0 1))) (if (null? act-1) ((TestC-45Golden-testReceiver arg-0 arg-1 arg-2 e-0) world-0) (let ((e-1 (unbox act-1))) ((TestC-45Golden-testReceiver arg-0 (TestC-45Golden-updateSummary e-1 arg-1) arg-2 u--nThreads) world-0)))))))))))
(define TestC-45Golden-testSender (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 0) (lambda (clam-0) (if (null? arg-2) 'erased (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-112) arg-0 (box e-1)) clam-0))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-0)))))))(else (let ((e-3 (- arg-1 1))) (lambda (clam-1) (if (null? arg-2) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-112) arg-0 '()) clam-1))) ((TestC-45Golden-testSender arg-0 e-3 '()) clam-1)) (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-112) arg-0 (box e-1)) clam-1))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-1)))))))))))
...
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-96 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define System-getArgs (lambda (arg-1) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (System-prim__getArgCount eta-0))))) (lambda (u--n) (let ((sc1 (PreludeC-45EqOrd-u--C-62_Ord_Int u--n (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (PreludeC-45Basics-flip (lambda (arg-14091) (lambda (arg-14098) (PreludeC-45Types-u--traverse_Traversable_List (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) e-10)) arg-14091 arg-14098))) (PreludeC-45Types-u--rangeFromTo_Range_C-36a (cons (vector csegen-7 (lambda (arg-6334) (lambda (arg-6337) (PreludeC-45Num-u--div_Integral_Int arg-6334 arg-6337))) (lambda (arg-6344) (lambda (arg-6347) (PreludeC-45Num-u--mod_Integral_Int arg-6344 arg-6347)))) (cons (vector (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Int arg-722 arg-725)))) (lambda (arg-1594) (lambda (arg-1597) (PreludeC-45EqOrd-u--compare_Ord_Int arg-1594 arg-1597))) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-60_Ord_Int arg-1604 arg-1607))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-62_Ord_Int arg-1614 arg-1617))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-60C-61_Ord_Int arg-1624 arg-1627))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-62C-61_Ord_Int arg-1634 arg-1637))) (lambda (arg-1644) (lambda (arg-1647) (PreludeC-45EqOrd-u--max_Ord_Int arg-1644 arg-1647))) (lambda (arg-1654) (lambda (arg-1657) (PreludeC-45EqOrd-u--min_Ord_Int arg-1654 arg-1657)))) (vector csegen-7 (lambda (arg-6034) (bs- 0 arg-6034 63)) (lambda (arg-6040) (lambda (arg-6043) (bs- arg-6040 arg-6043 63)))))) 0 (bs- u--n 1 63)) (lambda (eta-0) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-1) (System-prim__getArg eta-0 eta-1))))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) '())))))))))))))
...
(define TestC-45GoldenC-45RunnerHelper-nproc (lambda (ext-0) (let ((act-1 ((System-getEnv (force csegen-112) "NUM_THREADS") ext-0))) (let ((sc0 (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe act-1 (lambda (eta-0) (DataC-45String-parsePositive csegen-123 eta-0))))) (if (null? sc0) (let ((act-2 ((System-run (force csegen-112) "nproc") ext-0))) (if (null? act-2) '() (let ((e-2 (car act-2))) (let ((e-3 (cdr act-2))) (cond ((equal? e-3 0) (DataC-45String-parsePositive csegen-123 e-2))(else '())))))) (let ((e-2 (unbox sc0))) (box e-2)))))))
