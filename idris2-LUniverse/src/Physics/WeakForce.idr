...
public export
isDenominatorOverflow : Nat -> Multiset (VoxelNL, IntPolynumber) -> Bool
...
public export
triggerDecay : (1 particle : Multiset (VoxelNL, IntPolynumber)) -> LPair Bool (Multiset (VoxelNL, IntPolynumber))
