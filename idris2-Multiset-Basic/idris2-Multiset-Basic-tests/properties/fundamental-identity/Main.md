...
primePowerBox : Nat -> Nat -> MSet1
primePowerBox p n = fromList (map fromNat (powersUpTo p n))

fiaLeft : Nat -> MSet1
fiaLeft n = foldl (\acc, p => truncate n (carret acc (primePowerBox p n))) (fromList [fromNat 1]) (primesUpTo n)

box1ToN : Nat -> MSet1
box1ToN n = fromList (map fromNat [1 .. n])
