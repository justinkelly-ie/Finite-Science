...
public export
checkFrom : Testable a => Config -> MaxelNL (VoxelNL) -> a -> QCRes
checkFrom c univ x =
  let newGen : LCGState
...
public export
testFrom : Testable a => MaxelNL (VoxelNL) -> a -> QCRes
...
public export
quickCheckFrom : Testable a => MaxelNL (VoxelNL) -> a -> QCRes
