...
In Linear Physics, the entire topological and quantum state of the universe is modeled as a **Weighted Simplicial Complex**. By breaking down the core data structures in `Math.Core`, we can map the exact Idris 2 types to their topological equivalents.
