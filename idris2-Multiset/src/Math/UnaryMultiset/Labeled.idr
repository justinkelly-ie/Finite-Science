module Math.UnaryMultiset.Labeled
...
LabeledMSet l a = UnaryMultiset (LPair l (UnaryMultiset a))
...
export
countL : (LEq l, LComonoid l, LComonoid a) => (1 _ : l) -> (1 _ : LabeledMSet l a) -> LPair (UnaryMultiset ()) (LabeledMSet l a)
           ...
           Builtin.(#) res (Builtin.(#) l' k') =>
             case res of
               True => 
                 ...
                 in case Math.UnaryMultiset.Labeled.countL k2 xs of
                      Builtin.(#) n_rest xs_recon =>
                        case lconsume k' of
                          () => case lconsume orig of
                                  () => Builtin.(#) (n ++ n_rest) (Add (Builtin.(#) l' recon) xs_recon)
               False =>
                 case Math.UnaryMultiset.Labeled.countL k2 xs of
                   Builtin.(#) n_rest xs_recon =>
                     case lconsume k' of 
