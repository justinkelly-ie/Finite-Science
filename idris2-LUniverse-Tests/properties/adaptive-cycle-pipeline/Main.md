...
main : IO ()
main = do
  putStrLn "=== Adaptive Cycle Pipeline ==="\n  let r = QuickCheck.quickCheck prop_partitionProducesTwoParts
  putStrLn $ "prop_partitionProducesTwoParts: " ++ r.msg
  let r = QuickCheck.quickCheck prop_resonanceReduces
  putStrLn $ "prop_resonanceReduces: " ++ r.msg
  let r = QuickCheck.quickCheck prop_ascensionCondenses
  putStrLn $ "prop_ascensionCondenses: " ++ r.msg
  runProp "prop_canAscendRequiresBalance" prop_canAscendRequiresBalance
```
